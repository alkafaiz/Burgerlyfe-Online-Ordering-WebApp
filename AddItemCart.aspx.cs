...
{
    public partial class AddItemCart : System.Web.UI.Page
    {
        ...
        protected void btnAddtoCart_Click(object sender, EventArgs e)
        {
            ...
            {
                CO.AddtoCart(OrderID, MenuID, Convert.ToInt32(txtQty.Text));
        ...
        {
            Response.Redirect("EditQty.aspx?id=" + OrderID + "&mn=" + MenuID);
        }
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            ...
            //checkif item is in cart
            using (CreateOrder CO = new CreateOrder())
            {

                bool inCart = CO.checkinCart(OrderID, MenuID);
                if (inCart == true)
                {
                    txtQty.Enabled = false;
                    ...
                    ScriptManager.RegisterStartupScript(this, this.GetType(), "showadd", "showlabelAdded();", true);
                }
            }
